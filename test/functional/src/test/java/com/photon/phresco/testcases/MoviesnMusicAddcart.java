...
import com.photon.phresco.Screens.MoviesAndMusicScreen;
...
public class MoviesnMusicAddcart extends TestCase {
	...
	@Test
	public void testMoviesnMusic() throws InterruptedException, IOException,
			Exception {
		...
		try {
			...
			MoviesAndMusicScreen moviesandmusicScreen=browsing.gotomoMoviesAndMusicScreen(currentTestMethodName);
			moviesandmusicScreen.testMoviesAndMusicProducts();
		} catch (Exception t) {
			t.printStackTrace();
