...
import com.photon.phresco.Screens.MobilePhonesScreen;
...
public class MobilePhonesAddcart extends TestCase {
	...
	public void testMob() throws InterruptedException, IOException, Exception {
		...
		try {
			...
			MobilePhonesScreen mobilePhonesScreen=browsing.gotoMobilePhonesScreen(currentTestMethodName);
			mobilePhonesScreen.testMobilePhonesProducts();
