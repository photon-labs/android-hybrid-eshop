...
import com.photon.phresco.Screens.TabletsScreen;
...
public class TabletsAddCart extends TestCase {
	...
	@Test
	public void testTablets() throws InterruptedException, IOException,
			Exception {
		...
		try {
			...
			TabletsScreen tabletsScreen=browsing.gotoTabletsScreen(currentTestMethodName);
			tabletsScreen.testTabletsProducts();
		} catch (Exception t) {
			t.printStackTrace();
