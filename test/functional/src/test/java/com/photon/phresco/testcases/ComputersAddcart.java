...
import com.photon.phresco.Screens.ComputersScreen;
...
public class ComputersAddcart extends TestCase {
	...
	@Test
	public void testCompupterProducts() throws InterruptedException,
		...
		try {
			...
			ComputersScreen computerScreen=browsing.gotoComputersScreen(currentTestMethodName);
			computerScreen.testComputersProducts();
