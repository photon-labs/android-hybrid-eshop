...
import com.photon.phresco.Screens.CamerasScreen;
...
public class CamerasAddcart extends TestCase {
	...
	@Test
	public void testCameras() throws InterruptedException, IOException,
			Exception {
		...
		try {
			...
			CamerasScreen camerasScreen=browsing.gotoCamerasScreen(currentTestMethodName);
			camerasScreen.testCamerasPrducts();
		} catch (Exception t) {
			t.printStackTrace();
