...
import com.photon.phresco.Screens.AudioDevicesScreen;
...
public class AudioDevicesAddcart extends TestCase {
	...
	public void testAudio() throws InterruptedException, IOException, Exception {
		...
		try {
			...
			AudioDevicesScreen audioDevicesScreen=browsing.gotoAudioDevicesScreen(currentTestMethodName);
			audioDevicesScreen.testAudioDevicesProducts();
		} catch (Exception t) {
			t.printStackTrace();
