...
import com.photon.phresco.Screens.MP3PlayersScreen;
import com.photon.phresco.Screens.MenuScreen;
import com.photon.phresco.Screens.TelevisionScreen;
...
public class MP3PlayersAddcart extends TestCase {
	...
	public void testMP3Players() throws InterruptedException, IOException, Exception {
		...
		try {
			...
			MP3PlayersScreen mp3playerScreen=browsing.gotoMP3PlayersScreen(currentTestMethodName);
			mp3playerScreen.testMP3PlayersProducts();
