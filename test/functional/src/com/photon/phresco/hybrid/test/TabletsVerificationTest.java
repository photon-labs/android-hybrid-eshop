...
public class TabletsVerificationTest extends TestCase {
	...
	public TabletsVerificationTest(Solo solo) {
		this.soloMain = solo;

	}
@SuppressWarnings("unused")
	public void testTabletsVerificationTest(Instrumentation instrumentation)
		...
		try{
			...
			if(activityName.equalsIgnoreCase("Browse"))
			  {
				Log.i(TAG, "------It is testTabletsVerificationTest-----------" + activityName);
			   ...
			   // clicking the Login Browse
				...
				soloMain.getCurrentWebElements();
				soloMain.clickOnMenuItem("Tablets");
				
				soloMain.getCurrentWebElements();
				soloMain.sleep(2000);
				soloMain.clickOnMenuItem("Touch Screen Tablet");
				soloMain.sleep(3000);
				//soloMain.getCurrentWebElements();
