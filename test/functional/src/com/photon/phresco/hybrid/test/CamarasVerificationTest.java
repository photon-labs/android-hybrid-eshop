...
public class CamarasVerificationTest extends TestCase {
	...
	private static final String TAG = "*****CamarasVerificationTest******";
	
	
	public CamarasVerificationTest(Solo solo) {
		this.soloMain = solo;

	}
@SuppressWarnings("unused")
	public void testCamarasVerificationTest(Instrumentation instrumentation)
			throws TestException {
		try{
			Log.i(TAG, "------It is testCamarasVerificationTest()-----------");
			...
			if(activityName.equalsIgnoreCase("Browse"))
			  {
				Log.i(TAG, "------It is testCamarasVerificationTest-----------" + activityName);
				...
				for (int i = 0; i < 40; i++) 
					...
					Log.i(TAG, "------ testCamarasVerificationTest failed-----------");
			   ...
			   // clicking the Login Browse
				...
				soloMain.getCurrentWebElements();
				soloMain.clickOnMenuItem("Cameras");
				
				soloMain.getCurrentWebElements();
				soloMain.sleep(2000);
				soloMain.clickOnMenuItem("Lens");
				soloMain.sleep(3000);
				//soloMain.getCurrentWebElements();
